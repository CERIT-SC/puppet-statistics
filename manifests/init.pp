class statistics (
  ...
  Enum['https', 'http']                        $database_web_protocol     = $::statistics::params::database_web_protocol,
  String                                       $database_path_cert_file   = $::statistics::params::database_path_cert_file,
  String                                       $database_path_cert_key    = $::statistics::params::database_path_cert_key,
