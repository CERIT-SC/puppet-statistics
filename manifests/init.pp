class statistics (
  ...
  Hash                                         $telegraf_config_options      = $::statistics::params::telegraf_config_options,
  ...
  Array                                        $telegraf_plugins             = lookup('statistics::telegraf_plugins', Hash, 'hash', $::statistics::params::telegraf_plugins),
  ...
  Array                                        $collectd_plugins             = lookup('statistics::collectd_plugins', Hash, 'hash', $::statistics::params::collectd_plugins),
